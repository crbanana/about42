...
def write_article(idea: ArticleIdea) -> Optional[str]:
    ...
    system = SystemMessage(content=(
        ...
        "1. Лид — цепляющее вступление, 2-3 абзаца, задаёт тон и интригу\n"
        "2. Основная часть — разбита на разделы с подзаголовками ## \n"
        "   - Каждый раздел: 3-5 абзацев по 3-5 предложений\n"
        "   - НЕ пиши сплошное полотно текста без разделов\n"
        "   - Используй выделения: **жирный** для имён/ключевых фактов, *курсив* для эмоций\n"
        "   - Добавляй цитаты: > Когда Пятерка сказал...\n"
        "3. Заключение — итог, вывод, или вопрос аудитории\n"
        "\n"
        "Требования к форматированию:\n"
        "- Подзаголовки ## для каждого раздела\n"
        "- Абзацы разделяй пустой строкой\n"
        "- Списки (dash-списки) где уместно\n"
        "- НЕ используй ###, только ## и текст\n"
    ...
    human = HumanMessage(content=(
        ...
        "Напиши полноценную статью в Markdown. Обязательно используй подзаголовки ##, "
        "цитаты и разбивку на абзацы. НЕ пиши сплошным полотном."
    ))
