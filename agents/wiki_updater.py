...
def _extract_facts(transcript: str, video: VideoInfo, existing_wiki: str) -> str:
    ...
    system = SystemMessage(content=(
        ...
        "Пиши кратко, по делу. Выделяй: события, персонажей, игры, цитаты. "
        "Формат: Markdown с заголовками. Если информация дублирует существующую вики — "
        "укажи только новые факты."
    ))
    human = HumanMessage(content=(
        ...
        "Извлеки новые факты в формате Markdown."
    ))
